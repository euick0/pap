    ...
    return (
        <div className="z-2 fixed top-0 left-0 w-screen h-screen bg-black/70 flex justify-center items-center">
            <div className="bg-backgroundLight border-complement1 border-3 rounded-md w-8/12 h-8/12 relative flex overflow-hidden">
                <div className="abosolute w-0 h-0">
                ...
                <div className="flex-1 items-center flex-col flex">
                    <h1 className="text-center p-5 text-4xl antialiased font-semibold text-se">Log In</h1>
                    <input type="text" className="w-xl h-8 bg-transparent rounded-sm border border-white placeholder-white" placeholder=""></input>
                </div>
            </div>
        </div>
    );
